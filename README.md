...
- Show Message
- Get Messages
- Get Messages (with paginate)

**Note:** Even knowing that the ZapMe API supports interaction with contacts from the ZapMe platform (create, update, delete) for now, we are just trying to add the essential methods.
...
**Note:** Without pagination the maximum amount obtained will be 50.

```php
$result = $base->getMessages();
...
```php
$result = $base->getMessages(true, 1, 1);

{
    "status": true,
    "result": "success",
    "date": "2022-08-07 12:22:26",
    "data": {
        "current_page": 1,
        "data": [
            {
                "id": 1,
                "hash": "d3b138db5b212cded2c5",
                "message": "Ex iure deserunt voluptas totam minus sit cum laboriosam. Sint aut hic delectus reiciendis aut reiciendis autem. Amet illum facilis earum molestiae. Odio soluta accusamus numquam ratione ipsam.",
                "phone": "7930790068646",
                "type": "api",
                "status": "missing_number",
                "created_at": "2022-08-04T06:41:14.000000Z",
                "updated_at": "2022-08-04T06:41:14.000000Z"
            }
        ],
        "first_page_url": "http://api.zapme.com.br/messages?page=1",
        "from": 1,
        "last_page": 1307,
        "last_page_url": "http://api.zapme.com.br/messages?page=1307",
        "links": [
            {
                "url": null,
            ...
            {
                "url": "http://api.zapme.com.br/messages?page=1",
                "label": "1",
                "active": true
            },
            {
                "url": "http://api.zapme.com.br/messages?page=2",
                "label": "2",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=3",
                "label": "3",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=4",
                "label": "4",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=5",
                "label": "5",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=6",
                "label": "6",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=7",
                "label": "7",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=8",
                "label": "8",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=9",
                "label": "9",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=10",
                "label": "10",
                "active": false
            },
            {
            ...
            {
                "url": "http://api.zapme.com.br/messages?page=1306",
                "label": "1306",
                "active": false
            },
            {
                "url": "http://api.zapme.com.br/messages?page=1307",
                "label": "1307",
                "active": false
            },
            {
        ...
        "next_page_url": "http://api.zapme.com.br/messages?page=2",
        "path": "http://api.zapme.com.br/messages",
        "per_page": 1,
        "prev_page_url": null,
        "to": 1,
        "total": 1307
